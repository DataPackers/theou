...
# Tasks
scoreboard objectives add theou.task.aphrodite minecraft.custom:animals_bred
scoreboard objectives add theou.task.ares minecraft.killed:minecraft.zombie
scoreboard objectives add theou.task.hepheastus minecraft.crafted:minecraft.iron_sword
